...
#define TRIGGER_PINR  11  // Arduino pin tied to trigger pin on ping sensor.
#define ECHO_PINR     12  // Arduino pin tied to echo pin on ping sensor.
//
//
//
//const int trigL = 9;    
...
void setDirection(int dir, int speedLeft, int speedRight) {
...
//    
    _kmotor.tien(0, speedLeft);
    _kmotor.tien(1, speedRight);
